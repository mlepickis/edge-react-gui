...
export async function exportTransactionsToQBO(defaultIsoFiat: string, txs: EdgeTransaction[], currencyCode: string, denomination?: string): Promise<string> {
  return exportTransactionsToQBOInner(txs, currencyCode, defaultIsoFiat, denomination, Date.now())
}
